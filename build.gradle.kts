...
dependencies {
    ...
    runtimeOnly("org.postgresql:postgresql:42.7.7") // Remove fixed version when micronaut has updated to 42.5.5+
    ...
    testImplementation(platform("org.mockito:mockito-bom:5.19.0")) // Needs to be compatible with Micronaut BOM
