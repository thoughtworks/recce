...
val depDescriptors = mapOf(
    "micronaut" to "io.micronaut:micronaut-core:3.8.0",
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.15.0.Final"))
            .because(
...
dependencies {
    ...
    runtimeOnly("org.postgresql:postgresql:42.5.1") // Remove version override when micronaut-sql-bom >= 4.7.3
    ...
    testImplementation(platform("org.mockito:mockito-bom:4.11.0")) // Needs to be compatible with Micronaut BOM
...
jib {
    ...
    container {
        ...
        jvmFlags = listOf("-javaagent:/app/libs/reactor-tools-3.5.1.jar")
    }
}
