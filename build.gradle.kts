...
val depDescriptors = mapOf(
    ...
    "mockito" to "org.mockito:mockito-core:4.8.1", // Needs to be compatible with Micronaut BOM.
    "reactor" to "io.projectreactor:reactor-core:3.4.24" // Needs to be compatible with Micronaut BOM.
)
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.13.1.Final"))
            .because(
