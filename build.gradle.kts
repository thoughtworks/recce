...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.16.4.Final"))
            .because(
...
dependencies {
    ...
    runtimeOnly("org.postgresql:postgresql:42.5.4") // Remove version override when micronaut-sql-bom >= 4.7.3
    ...
    testImplementation(platform("org.mockito:mockito-bom:5.2.0")) // Needs to be compatible with Micronaut BOM
