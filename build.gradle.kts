...
val depDescriptors = mapOf(
    "micronaut" to "io.micronaut:micronaut-core:3.3.3",
    ...
    "flyway" to "org.flywaydb:flyway-core:8.5.1", // Needs to be compatible with Micronaut BOM.
)
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.7.2.Final"))
            .because(
