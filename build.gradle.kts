...
val depDescriptors = mapOf(
    "micronaut" to "io.micronaut:micronaut-core:3.8.4",
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.16.0.Final"))
            .because(
...
dependencies {
    ...
    runtimeOnly("org.postgresql:postgresql:42.5.3") // Remove version override when micronaut-sql-bom >= 4.7.3
