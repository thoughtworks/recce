...
val depDescriptors = mapOf(
    "micronaut" to "io.micronaut:micronaut-core:3.2.3",
    ...
    "mockito" to "org.mockito:mockito-core:4.2.0", // Needs to be compatible with Micronaut BOM.
    "reactor" to "io.projectreactor:reactor-core:3.4.13" // Needs to be compatible with Micronaut BOM.
)
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.6.1.Final"))
            .because(
