...
val depDescriptors = mapOf(
    "micronaut" to "io.micronaut:micronaut-core:3.2.7",
    ...
    "mockito" to "org.mockito:mockito-core:4.3.0", // Needs to be compatible with Micronaut BOM.
...
configurations.all {
    resolutionStrategy.dependencySubstitution {
        substitute(module("junit:junit"))
            .using(module("io.quarkus:quarkus-junit4-mock:2.6.3.Final"))
            .because(
